            ...
            <div class="p-4">
                <div class="w-full">
                    ...
                    <form action="{{ route('threads.update', $thread) }}" method="post">
                        ...
                        <input type="submit" value="Edit" class="w-full py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:to-blue-700 text-white/90 font-bold text-xs rounded-md">
                    </form>
                </div>
            </div>
        </div>
